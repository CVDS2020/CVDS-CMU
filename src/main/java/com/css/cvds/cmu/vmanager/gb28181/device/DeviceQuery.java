package com.css.cvds.cmu.vmanager.gb28181.device;
...
import com.css.cvds.cmu.vmanager.gb28181.device.bean.AddDeviceParam;
...
public class DeviceQuery {
	...
	public PageInfo<Device> devices(int page, int count,
		...
		return storager.queryVideoDeviceList(page, count, keyword, online, superviseTargetId);
	}
	...
	@ResponseBody
	public Object add(@RequestBody AddDeviceParam addDeviceParam) {
