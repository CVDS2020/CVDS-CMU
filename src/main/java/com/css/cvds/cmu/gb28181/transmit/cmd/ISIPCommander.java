package com.css.cvds.cmu.gb28181.transmit.cmd;
...
public interface ISIPCommander {
	 ...
	 * @param channelId  预览通道
	 */
	void playStreamCmd(MediaServerItem mediaServerItem, Device device, String channelId, SipSubscribe.Event okEvent, SipSubscribe.Event errorEvent) throws InvalidArgumentException, SipException, ParseException;
