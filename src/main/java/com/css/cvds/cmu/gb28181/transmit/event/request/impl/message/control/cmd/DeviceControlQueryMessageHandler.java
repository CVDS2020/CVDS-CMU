package com.css.cvds.cmu.gb28181.transmit.event.request.impl.message.control.cmd;

import com.css.cvds.cmu.gb28181.transmit.event.request.impl.message.control.ControlMessageHandler;
...
public class DeviceControlQueryMessageHandler extends SIPRequestProcessorParent implements InitializingBean, IMessageHandler {
    ...
    public void handForPlatform(RequestEvent evt, ParentPlatform parentPlatform, Element rootElement) {
        ...
        if (!ObjectUtils.isEmpty(getText(rootElement,"PTZCmd")) && !parentPlatform.getServerGBId().equals(targetGBId)) {
            try {
                responseAck(serverTransaction, Response.UNSUPPORTED_URI_SCHEME);
